#ifndef ThermalPlant_FMU_H
#define ThermalPlant_FMU_H

#include "simulation_data.h"

// define class name and unique id
#define MODEL_IDENTIFIER ThermalPlant
#define MODEL_GUID "{9e3c718c-420b-4862-b399-421672c2ed21}"

// define model size
#define NUMBER_OF_STATES 1
#define NUMBER_OF_EVENT_INDICATORS 0
#define NUMBER_OF_REALS 9
#define NUMBER_OF_REAL_INPUTS 2
...
extern void ThermalPlant_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc ThermalPlant_setupDataStruc
#include "fmi-export/fmu2_model_interface.h"
#include "fmi-export/fmu_read_flags.h"

#define FMI2_FUNCTION_PREFIX ThermalPlant_
